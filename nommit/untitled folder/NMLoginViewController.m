...
- (void)loadView {
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_logoView]-50-[_loginContainer]" options:0 metrics:nil views:views]];
