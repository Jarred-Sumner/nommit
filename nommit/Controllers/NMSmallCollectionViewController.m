//
//  NMSmallCollectionViewController.m
//  nommit
//
...
#import "NMCollectionViewLargeLayout.h"

@interface NMSmallCollectionViewController ()
...
@implementation NMSmallCollectionViewController
...
- (UICollectionViewController *)nextViewControllerAtPoint:(CGPoint)point
{
    ...
    NMCollectionViewLargeLayout *largeLayout = [[NMCollectionViewLargeLayout alloc] init];
    NMBaseCollectionViewController *nextCollectionViewController = [[NMBaseCollectionViewController alloc] initWithCollectionViewLayout:largeLayout];
