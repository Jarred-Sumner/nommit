...
@property (nonatomic, readonly, strong) NMSubscriptionID* objectID;

@property (nonatomic, strong) NSNumber* email;

@property (atomic) BOOL emailValue;
- (BOOL)emailValue;
...
@property (atomic) BOOL pushNotificationsValue;
